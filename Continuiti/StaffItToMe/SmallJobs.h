...
@property (nonatomic, assign) double job_distance;
@property (nonatomic, assign) NSString *title;
@property (nonatomic, assign) NSString *job_description;
...
@property (nonatomic, assign) NSString *job_city;
@property (nonatomic, assign) NSString *job_state;
@property (nonatomic, assign) NSString *job_type_title;
@property (nonatomic, assign) NSString *industry_name;
