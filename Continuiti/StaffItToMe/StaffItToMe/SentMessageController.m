...
{
    StaffItToMeAppDelegate *app_delegate = (StaffItToMeAppDelegate*)[[UIApplication sharedApplication] delegate];
    return ([app_delegate.user_state_information.my_sent_messages count] + 1);
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0)
    {
        ...
        UILabel *spam_your_friends_label = [[UILabel alloc] initWithFrame:CGRectMake(10, 8, 200, 22)];
        ...
        spam_your_friends_label.text = @"Sent Messages";
        [cell_view addSubview:spam_your_friends_label];
        [the_cell.contentView addSubview:cell_view];
    }
    else
    {
        InboxCell *cell_view = [[InboxCell alloc] initwithDetail:[[app_delegate.user_state_information.my_sent_messages objectAtIndex:indexPath.row-1] my_body] andArrow:YES];
        [the_cell.contentView addSubview:cell_view];
    }
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [delegate goToSentMessage:indexPath.row-1];
}
