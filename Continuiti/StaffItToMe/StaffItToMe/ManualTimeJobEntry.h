...
@protocol ManualTimeJobEntryProtocol <NSObject>
-(void)removeManualTimeJobEntryDetail;
@end

@interface ManualTimeJobEntry : UIViewController<UINavigationControllerDelegate,  UIImagePickerControllerDelegate, UITextViewDelegate, UIAlertViewDelegate, UIActionSheetDelegate, UITextFieldDelegate, AudioRecordingScreenProtocol> {
    int job_pos;
...
@property (retain) id <ManualTimeJobEntryProtocol> delegate;
@end
