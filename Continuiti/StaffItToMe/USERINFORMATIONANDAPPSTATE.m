...
-(id)init
{
    if ((self = [super init]))
    {
        ...
        industry_search_type = [[NSString alloc] initWithString:@"All"];
        salary_search_type = [[NSString alloc] initWithString:@"All"];
        distance_search_type = [[NSString alloc] initWithString:@"All"];
