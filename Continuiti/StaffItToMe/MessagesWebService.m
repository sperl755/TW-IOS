...
@implementation MessagesWebService
...
- (void)viewDidLoad
{
    ...
    @try {
        ...
        NSMutableString *string = [[NSMutableString alloc] initWithString:@"https://www.talentwire.me/"];
        ...
        [string appendString:@"/messages?header=no&mobile=true"];
        startoff_request = [[NSMutableString alloc] initWithString:string];
    }
